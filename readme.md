# Council [![Build Status](https://travis-ci.org/coxy121/council.svg?branch=master)](https://travis-ci.org/coxy121/council)
...
```bash
git clone git@github.com:coxy121/council.git
